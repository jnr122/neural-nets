...
class Agent:
    def __init__(self, num_actions, state_size):
        ...
        hidden_layer_9 = tf.layers.dense(hidden_layer_8, 8, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_10 = tf.layers.dense(hidden_layer_9, 16, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_11 = tf.layers.dense(hidden_layer_10, 8, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_12 = tf.layers.dense(hidden_layer_11, 8, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_13 = tf.layers.dense(hidden_layer_12, 8, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_14 = tf.layers.dense(hidden_layer_13, 8, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_15 = tf.layers.dense(hidden_layer_14, 8, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_16 = tf.layers.dense(hidden_layer_15, 8, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_17 = tf.layers.dense(hidden_layer_16, 8, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_18 = tf.layers.dense(hidden_layer_17, 8, activation=tf.nn.relu, kernel_initializer=initializer)

        # Output of neural net
        out = tf.layers.dense(hidden_layer_18, num_actions, activation=None)
...
with tf.Session() as sess:
    ...
    for episode in range(training_episodes):
        ...
        if episode % 10 == 0:
            ...
            print("Average reward / 10 eps: " + str(np.mean(total_episode_rewards[-10:])))
# Testing the Agent
testing_episodes = 5
